...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="master_quiz4.css">
        <title>Unidad 4 - Quiz | Platanopedia</title>
    ...
    <body>
        ...
        <div id="pantalla-inicial">
            <p>Cosecha del plátano</p>
            <button class="btn" onclick="comenzarJuego()">Iniciar prueba</button>
            <div class="ImgInicial"> <img src="img/platanopedia_unidad4-1.png" alt="" id="ImgUnidad1"> </div>
        </div>

        <!-- Pantalla juego -->
        <div class="pantalla-juego" id="pantalla-juego">

            <img src="img/pregunta1U4.svg" alt="" id="imgBandera">
        ...
        <script src="log_quiz4.js"></script>
    </body>
</html>
