...
<html>
    <head>
        <meta charset="utf-8">
        <title>Unidad 4 | Cosecha - Platanopedia</title>
        <link rel="stylesheet" type="text/css" href="<?php echo $URL?>/public/css/master_unidad4.css">
        <link rel="icon" href="<?php echo $URL?>/public/images/platanopedia_logo-1.png">
    </head>

    <body>
        <a>Unidad 4 | Cosecha - Platanopedia</a>
        <div class="head">
        ...
        <div>
            <div class="gallery">
                <a href="tema1/cosecha.php">
                    <img src="<?php echo $URL?>/public/images/platanopedia_contenido_u4.png" width="100"
                </a><br>
                <a>Contenido</a>
            </div>

            <div class="gallery">
                <a href="quiz4/quiz4.php">
