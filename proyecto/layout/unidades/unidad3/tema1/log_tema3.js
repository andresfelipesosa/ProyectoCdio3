...
*/
    ...
    document.getElementById("moko").style.display = "none";
    document.getElementById("sigatoka").style.display = "none";
    document.getElementById("elefantiasis").style.display = "none";


// BOTONES DE SIGUIENTE: --------------------------------------------------------------------
function introS(){
    document.getElementById("intro").style.display = "none";
    document.getElementById("moko").style.display = "block";
    document.getElementById("sigatoka").style.display = "none";
    document.getElementById("elefantiasis").style.display = "none";
}
...
function mokoS(){
    document.getElementById("intro").style.display = "none";
    document.getElementById("moko").style.display = "none";
    document.getElementById("sigatoka").style.display = "block";
    document.getElementById("elefantiasis").style.display = "none";
}
...
function sigatokaS(){
    ...
    document.getElementById("moko").style.display = "none";
    document.getElementById("sigatoka").style.display = "none";
    document.getElementById("elefantiasis").style.display = "block";
}

function elefantiasisS(){
    document.getElementById("intro").style.display = "block";
    document.getElementById("moko").style.display = "none";
    document.getElementById("sigatoka").style.display = "none";
    document.getElementById("elefantiasis").style.display = "none";
