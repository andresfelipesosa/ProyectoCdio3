...
<html>
    <head>
        <meta charset="utf-8">
        <title>Unidad 3 | Control de Plagas y Enfermedades - Platanopedia</title>
        <link rel="stylesheet" type="text/css" href="<?php echo $URL?>/public/css/master_unidad3.css">
    ...
    <body>
        ...
        <div>
            ...
            <div class="gallery">
                <a href="tema1/plagas_enfermedades.php">
                    <img src="<?php echo $URL?>/public/images/platanopedia_contenido_u3.png" width="100"
                </a><br>
                <a>Contenido</a>
            </div>

            <div class="gallery">
                <a href="quiz3/quiz3.php">
