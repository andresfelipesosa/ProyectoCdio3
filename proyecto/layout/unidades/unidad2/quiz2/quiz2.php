...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="master_quiz2.css">
        <title>Unidad 2 - Quiz | Platanopedia</title>
    ...
    <body>
        ...
        <h1>Cuestionario Unidad 2</h1>

        <!-- Pantalla inicial -->
        <div id="pantalla-inicial">
            <p>Mantenimiento del cultivo</p>
            <button class="btn" onclick="comenzarJuego()">Iniciar prueba</button>
            <div class="ImgInicial"> <img src="img/platanopedia_unidad2-1.png" alt="" id="ImgUnidad1"> </div>
        </div>

        <!-- Pantalla juego -->
        <div class="pantalla-juego" id="pantalla-juego">

            <img src="img/pregunta1U2.svg" alt="" id="imgBandera">
        ...
        <script src="log_quiz2.js"></script>
    </body>
</html>
