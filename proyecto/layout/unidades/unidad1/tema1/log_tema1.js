...
*/
    ...
    document.getElementById("colino").style.display = "none";
    document.getElementById("partesplanta").style.display = "none";
    document.getElementById("cultivoplatano").style.display = "none";


// BOTONES DE SIGUIENTE: --------------------------------------------------------------------
function introS(){
    document.getElementById("intro").style.display = "none";
    document.getElementById("colino").style.display = "block";
    document.getElementById("partesplanta").style.display = "none";
    document.getElementById("cultivoplatano").style.display = "none";
}
...
function colinoS(){
    document.getElementById("intro").style.display = "none";
    document.getElementById("colino").style.display = "none";
    document.getElementById("partesplanta").style.display = "block";
    document.getElementById("cultivoplatano").style.display = "none";
}

function partesplantaS(){
    document.getElementById("intro").style.display = "none";
    document.getElementById("colino").style.display = "none";
    document.getElementById("partesplanta").style.display = "none";
    document.getElementById("cultivoplatano").style.display = "block";
}
