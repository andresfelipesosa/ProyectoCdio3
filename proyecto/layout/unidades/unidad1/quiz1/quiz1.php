...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="master_quiz1.css">
        <title>Unidad 1 - Quiz | Platanopedia</title>
    ...
    <body>
        ...
        <div id="pantalla-inicial">
            <p>Conceptos Básicos del Sembrado</p>
            <button class="btn" onclick="comenzarJuego()">Iniciar prueba</button>
            <div class="ImgInicial"> <img src="img/platanopedia_unidad1-1.png" alt="" id="ImgUnidad1"> </div>
        </div>

        <!-- Pantalla juego -->
        <div class="pantalla-juego" id="pantalla-juego">

            <img src="/img/pregunta1U1.svg" alt="" id="imgBandera">
        ...
        <input id="username" type="text" style="display:none" value="<?php echo $username; ?>">

        <script src="log_quiz1.js"></script>
    </body>
</html>
