...
<html>
    <head>
        <meta charset="utf-8">
        <title>Unidad 1 | Conceptos básicos de Sembrado - Platanopedia</title>
        <link rel="stylesheet" type="text/css" href="<?php echo $URL?>/public/css/master_unidad1.css">
    ...
    <body>
        ...
        <div>
            ...
            <div class="gallery">
                <a href="tema1/conceptos_basicos.php">
                    <img src="<?php echo $URL?>/public/images/platanopedia_contenido_u1.png" width="100"
                </a><br>
                <a>Contenido</a>
            </div>

            <div class="gallery">
                <a href="quiz1/quiz1.php">
